...
public class DessertsAdapter extends RecyclerView.Adapter<DessertsAdapter.DessertsViewHolder> {
    ...
    @Override
    public DessertsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.pizza_item, parent, false);
        return new DessertsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DessertsViewHolder holder, int position) {
    ...
    public static class DessertsViewHolder extends RecyclerView.ViewHolder {
        TextView productName, productDescription, productPrice;
        ImageView productImage;

        public DessertsViewHolder(View itemView) {
            super(itemView);
